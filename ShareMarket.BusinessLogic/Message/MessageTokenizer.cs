...
namespace ShareMarket.BusinessLogic.Message
{
    public class MessageTokenizer
    {
        ...
        {
            bool isCaseInvariantReplacement = false;
            //bool.TryParse(SettingManager.Instance.Get(name: "Message.CaseInvariantReplacement").Value, out isCaseInvariantReplacement);
            _stringComparison = isCaseInvariantReplacement ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal;
        }
        ...
        public string Replace(string template, IEnumerable<BusinessLogic.Message.MessageToken> tokens, bool htmlEncode)
        {
