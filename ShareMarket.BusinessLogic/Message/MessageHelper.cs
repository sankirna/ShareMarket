    ...
    public class MessageHelper
    {
        public static int SendNotification(MessageTemplate messageTemplate, IEnumerable<MessageToken> tokens, string toEmailAddress, string toName)
        {
                    ...
                    GlobalUtil.Container.Resolve<IDataRepository<QueuedEmail>>())
            {
                ...
                string body = messageTemplate.Body;
                ...
                var from = GlobalLib.SettingValue("Email.From");
                var fromName = GlobalLib.SettingValue("Email.From.DisplayName");
                ...
                email = queuedEmailContext.Add(email);
        ...
        public static int SendNotification(MessageTemplate messageTemplate, IEnumerable<MessageToken> tokens, string toMobileNumber)
        {
                    ...
                    GlobalUtil.Container.Resolve<IDataRepository<QueuedSms>>())
            {
                ...
                bodyReplaced = HtmlRemovalUtil.StripTagsRegex(bodyReplaced);
